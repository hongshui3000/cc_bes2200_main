...
#define HAL_SW_BOOTMODE_TEST                    (1 << 14)
...
#define HAL_SW_BOOTMODE_REBOOT_VERSION_CHECK 	(1 << 24)

#define HAL_SW_BOOTMODE_REBOOT_DUMPERENABLE     (1 << 27)
#define HAL_SW_BOOTMODE_REBOOT_CRASHDUMP      (1 << 28)
#ifdef __BT_ANC__
