...
#ifdef SPDIF_VOLTAGE_VMEM
#define SPDIF_VOLTAGE_SEL                   HAL_IOMUX_PIN_VOLTAGE_MEM
#else
#define SPDIF_VOLTAGE_SEL                   HAL_IOMUX_PIN_VOLTAGE_VIO
#endif
...
void hal_iomux_set_jtag(void)
{
    ...
    // Set jtag func
    iomux->REG_004 = (iomux->REG_004 & ~(IOMUX_FUNC_SEL_P0_0_MASK | IOMUX_FUNC_SEL_P0_1_MASK |
        IOMUX_FUNC_SEL_P0_2_MASK | IOMUX_FUNC_SEL_P0_3_MASK | IOMUX_FUNC_SEL_P0_4_MASK)) |
        IOMUX_FUNC_SEL_P0_0(2) | IOMUX_FUNC_SEL_P0_1(2) | IOMUX_FUNC_SEL_P0_2(2) |
        IOMUX_FUNC_SEL_P0_3(2) | IOMUX_FUNC_SEL_P0_4(2);

    mask = (1 << HAL_IOMUX_PIN_P0_0) | (1 << HAL_IOMUX_PIN_P0_1) | (1 << HAL_IOMUX_PIN_P0_2) |
        (1 << HAL_IOMUX_PIN_P0_3) | (1 << HAL_IOMUX_PIN_P0_4);
    // Set vio voltage
    iomux->REG_020 &= ~mask;
    // Clear pullup
    iomux->REG_02C &= ~mask;
...
void hal_iomux_set_i2c_2(void)
{
#if 1
    static const struct HAL_IOMUX_PIN_FUNCTION_MAP pinmux_i2c_2[] = {
        {HAL_IOMUX_PIN_P2_6, HAL_IOMUX_FUNC_I2C_M_SCL, HAL_IOMUX_PIN_VOLTAGE_VIO, HAL_IOMUX_PIN_PULLUP_ENALBE},
        {HAL_IOMUX_PIN_P2_7, HAL_IOMUX_FUNC_I2C_M_SDA,  HAL_IOMUX_PIN_VOLTAGE_VIO, HAL_IOMUX_PIN_PULLUP_ENALBE},
    };
#endif
#if 0
    static const struct HAL_IOMUX_PIN_FUNCTION_MAP pinmux_i2c_2[] = {
        {HAL_IOMUX_PIN_P2_6, HAL_IOMUX_FUNC_GPIO, HAL_IOMUX_PIN_VOLTAGE_VIO, HAL_IOMUX_PIN_PULLUP_ENALBE},
        {HAL_IOMUX_PIN_P2_7, HAL_IOMUX_FUNC_GPIO,  HAL_IOMUX_PIN_VOLTAGE_VIO, HAL_IOMUX_PIN_PULLUP_ENALBE},
    };
#endif    

    hal_iomux_init(pinmux_i2c_2, ARRAY_SIZE(pinmux_i2c_2));
//hal_gpio_pin_set_dir(HAL_IOMUX_PIN_P2_6,HAL_GPIO_DIR_OUT,1);
///hal_gpio_pin_set_dir(HAL_IOMUX_PIN_P2_7,HAL_GPIO_DIR_OUT,1);
}
...
void hal_iomux_set_spdif0(void)
{
    static const struct HAL_IOMUX_PIN_FUNCTION_MAP pinmux_spdif[] = {
        {HAL_IOMUX_PIN_P3_2, HAL_IOMUX_FUNC_SPDIF0_DI, SPDIF_VOLTAGE_SEL, HAL_IOMUX_PIN_PULLUP_ENALBE},
        {HAL_IOMUX_PIN_P3_3, HAL_IOMUX_FUNC_SPDIF0_DO, SPDIF_VOLTAGE_SEL, HAL_IOMUX_PIN_PULLUP_ENALBE},
    };
...
{
    static const struct HAL_IOMUX_PIN_FUNCTION_MAP pinmux_spdif[] = {
#if (SPDIF1_DI_IOMUX_INDEX == 0)
        {HAL_IOMUX_PIN_P0_3, HAL_IOMUX_FUNC_SPDIF1_DI, SPDIF_VOLTAGE_SEL, HAL_IOMUX_PIN_PULLUP_ENALBE},
#elif (SPDIF1_DI_IOMUX_INDEX == 1)
        {HAL_IOMUX_PIN_P3_3, HAL_IOMUX_FUNC_SPDIF1_DI, SPDIF_VOLTAGE_SEL, HAL_IOMUX_PIN_PULLUP_ENALBE},
#elif (SPDIF1_DI_IOMUX_INDEX == 2)
        {HAL_IOMUX_PIN_P3_4, HAL_IOMUX_FUNC_SPDIF1_DI, SPDIF_VOLTAGE_SEL, HAL_IOMUX_PIN_PULLUP_ENALBE},
#elif (SPDIF1_DI_IOMUX_INDEX == 3)
        {HAL_IOMUX_PIN_P4_0, HAL_IOMUX_FUNC_SPDIF1_DI, SPDIF_VOLTAGE_SEL, HAL_IOMUX_PIN_PULLUP_ENALBE},
#else
        {HAL_IOMUX_PIN_P4_4, HAL_IOMUX_FUNC_SPDIF1_DI, SPDIF_VOLTAGE_SEL, HAL_IOMUX_PIN_PULLUP_ENALBE},
#endif

#if (SPDIF1_DO_IOMUX_INDEX == 0)
        {HAL_IOMUX_PIN_P3_2, HAL_IOMUX_FUNC_SPDIF1_DO, SPDIF_VOLTAGE_SEL, HAL_IOMUX_PIN_PULLUP_ENALBE},
#elif (SPDIF1_DO_IOMUX_INDEX == 1)
        {HAL_IOMUX_PIN_P3_5, HAL_IOMUX_FUNC_SPDIF1_DO, SPDIF_VOLTAGE_SEL, HAL_IOMUX_PIN_PULLUP_ENALBE},
#elif (SPDIF1_DO_IOMUX_INDEX == 1)
        {HAL_IOMUX_PIN_P3_7, HAL_IOMUX_FUNC_SPDIF1_DO, SPDIF_VOLTAGE_SEL, HAL_IOMUX_PIN_PULLUP_ENALBE},
#else
        {HAL_IOMUX_PIN_P4_5, HAL_IOMUX_FUNC_SPDIF1_DO, SPDIF_VOLTAGE_SEL, HAL_IOMUX_PIN_PULLUP_ENALBE},
#endif
    };
...
void hal_iomux_set_dig_mic(uint32_t map)
{
    static const struct HAL_IOMUX_PIN_FUNCTION_MAP pinmux_digitalmic0[] = {
        {HAL_IOMUX_PIN_P3_7, HAL_IOMUX_FUNC_PDM0_CK, DIGMIC_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
    ...
    static const struct HAL_IOMUX_PIN_FUNCTION_MAP pinmux_digitalmic1[] = {
        {HAL_IOMUX_PIN_P4_2, HAL_IOMUX_FUNC_PDM1_CK, DIGMIC_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
...
#if (DIG_MIC2_CK_IOMUX_INDEX == 0)
        {HAL_IOMUX_PIN_P2_2, HAL_IOMUX_FUNC_PDM2_CK, DIGMIC_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
#elif (DIG_MIC2_CK_IOMUX_INDEX == 1)
        {HAL_IOMUX_PIN_P3_2, HAL_IOMUX_FUNC_PDM2_CK, DIGMIC_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
#else
        {HAL_IOMUX_PIN_P4_6, HAL_IOMUX_FUNC_PDM2_CK, DIGMIC_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
#endif
...
#if (DIG_MIC3_CK_IOMUX_INDEX == 0)
        {HAL_IOMUX_PIN_P2_3, HAL_IOMUX_FUNC_PDM3_CK, DIGMIC_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
#elif (DIG_MIC3_CK_IOMUX_INDEX == 1)
        {HAL_IOMUX_PIN_P3_3, HAL_IOMUX_FUNC_PDM3_CK, DIGMIC_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
#else
...
void hal_iomux_set_spi(void)
{
    ...
    hal_gpio_pin_set_dir(pinmux_spi_4wire.pin, HAL_GPIO_DIR_IN, 0);
