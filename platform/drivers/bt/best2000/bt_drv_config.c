...
#else
    0xBF,0xFE,0xCD,0xFa,0xD8,0xbd,0x7b,0x87////Modified by ATX : change to 0xD8,0xbd, fixing Meizu Pro6 plus and Meilan S6 no voice during call
#endif
};
