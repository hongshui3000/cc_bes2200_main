...
static void POSSIBLY_UNUSED gd25lq32c_write_status_s8_s15(uint8_t status)
{
    norflash_write_reg(GD25LQ32C_CMD_WRITE_STATUS_S8_S15, &status, 1);
}

/*
static void gd25lq32c_write_status_s0_s7(uint8_t status)
{
    norflash_write_reg(GD25LQ32C_CMD_WRITE_STATUS_S0_S7, &status, 1);
}
*/
