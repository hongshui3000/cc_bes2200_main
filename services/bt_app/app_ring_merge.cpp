...
static void app_ring_merge_8000(uint8_t media_id)
{
    switch (media_id) {
        case AUD_ID_BT_VOL_MAX:
        	if(0 != sizeof(RES_AUD_RING_SAMPRATE_8000_VOL_MAX))
        	{
				app_ring_merge_setup((int16_t *)RES_AUD_RING_SAMPRATE_8000_VOL_MAX, sizeof(RES_AUD_RING_SAMPRATE_8000_VOL_MAX)/sizeof(int16_t), APP_RING_MERGE_PLAY_ONESHOT);
				app_ring_merge_config.running = true;
        	}
            break;
		case AUD_ID_BT_WARNING:
        	if(0 != sizeof(RES_AUD_RING_SAMPRATE_8000_WARNING))
        	{
				app_ring_merge_setup((int16_t *)RES_AUD_RING_SAMPRATE_8000_WARNING, sizeof(RES_AUD_RING_SAMPRATE_8000_WARNING)/sizeof(int16_t), APP_RING_MERGE_PLAY_ONESHOT);
				app_ring_merge_config.running = true;
        	}
            break;
        default:
...
static void app_ring_merge_16000(uint8_t media_id)
{
	switch (media_id) {
		case AUD_ID_BT_VOL_MAX:
        	if(0 != sizeof(RES_AUD_RING_SAMPRATE_16000_VOL_MAX))
        	{
				app_ring_merge_setup((int16_t *)RES_AUD_RING_SAMPRATE_16000_VOL_MAX, sizeof(RES_AUD_RING_SAMPRATE_16000_VOL_MAX)/sizeof(int16_t), APP_RING_MERGE_PLAY_ONESHOT);
				app_ring_merge_config.running = true;
        	}
			break;
		case AUD_ID_BT_WARNING:
        	if(0 != sizeof(RES_AUD_RING_SAMPRATE_16000_WARNING))
        	{
				app_ring_merge_setup((int16_t *)RES_AUD_RING_SAMPRATE_16000_WARNING, sizeof(RES_AUD_RING_SAMPRATE_16000_WARNING)/sizeof(int16_t), APP_RING_MERGE_PLAY_ONESHOT);
				app_ring_merge_config.running = true;
        	}
            break;
		default:
...
static void app_ring_merge_44100(uint8_t media_id)
{
    switch (media_id) {
        case AUD_ID_BT_VOL_MAX:
        	if(0 != sizeof(RES_AUD_RING_SAMPRATE_44100_VOL_MAX))
        	{
				app_ring_merge_setup((int16_t *)RES_AUD_RING_SAMPRATE_44100_VOL_MAX, sizeof(RES_AUD_RING_SAMPRATE_44100_VOL_MAX)/sizeof(int16_t), APP_RING_MERGE_PLAY_ONESHOT);
				app_ring_merge_config.running = true;
        	}
            break;
		case AUD_ID_BT_WARNING:
        	if(0 != sizeof(RES_AUD_RING_SAMPRATE_44100_WARNING))
        	{
				app_ring_merge_setup((int16_t *)RES_AUD_RING_SAMPRATE_44100_WARNING, sizeof(RES_AUD_RING_SAMPRATE_44100_WARNING)/sizeof(int16_t), APP_RING_MERGE_PLAY_ONESHOT);
				app_ring_merge_config.running = true;
        	}
            break;
        default:
...
static void app_ring_merge_48000(uint8_t media_id)
{
    switch (media_id) {
        case AUD_ID_BT_VOL_MAX:
        	if(0 != sizeof(RES_AUD_RING_SAMPRATE_48000_VOL_MAX))
        	{
				app_ring_merge_setup((int16_t *)RES_AUD_RING_SAMPRATE_48000_VOL_MAX, sizeof(RES_AUD_RING_SAMPRATE_48000_VOL_MAX)/sizeof(int16_t), APP_RING_MERGE_PLAY_ONESHOT);
				app_ring_merge_config.running = true;
        	}
            break;
		case AUD_ID_BT_WARNING:
        	if(0 != sizeof(RES_AUD_RING_SAMPRATE_48000_WARNING))
        	{
				app_ring_merge_setup((int16_t *)RES_AUD_RING_SAMPRATE_48000_WARNING, sizeof(RES_AUD_RING_SAMPRATE_48000_WARNING)/sizeof(int16_t), APP_RING_MERGE_PLAY_ONESHOT);
				app_ring_merge_config.running = true;
        	}
            break;
        default:
...
#endif//__BT_WARNING_TONE_MERGE_INTO_STREAM_SBC__

bool app_ring_merge_start(uint8_t media_id)
{
    ...
    switch (stream_cfg->sample_rate) {
        case AUD_SAMPRATE_8000:
            app_ring_merge_8000(media_id);
            break;
        case AUD_SAMPRATE_16000:
            app_ring_merge_16000(media_id);
            break;
#ifdef __BT_WARNING_TONE_MERGE_INTO_STREAM_SBC__
        case AUD_SAMPRATE_44100:
            app_ring_merge_44100(media_id);
            break;
        case AUD_SAMPRATE_48000:
            app_ring_merge_48000(media_id);
            break;
#endif
        default:
            break;
    ...
    return app_ring_merge_config.running;
}
