...
void app_anc_usb_init(void)
{
    ...
    anc_tester_init(AUD_INPUT_PATH_MAINMIC, AUD_SAMPRATE_96000, AUD_SAMPRATE_192000);

    usb_audio_tester_init(app_test_playback_buff, USB_AUDIO_PLAYBACK_BUFF_SIZE,
    ...
    //dualadc_audio_tester_init(app_test_playback_buff, USB_AUDIO_PLAYBACK_BUFF_SIZE,
        //app_test_capture_buff, USB_AUDIO_CAPTURE_BUFF_SIZE);
}
#endif
