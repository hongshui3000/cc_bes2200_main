...
#if defined (__TOUCH_KEY__)&&defined(__PC_CMD_UART__) //Modified by ATX : Parke.Wei_20180331
extern "C" int touch_key_event_process(uint32_t key_code, uint8_t key_event)
{
    uint32_t app_keyevt;
    APP_MESSAGE_BLOCK msg;
