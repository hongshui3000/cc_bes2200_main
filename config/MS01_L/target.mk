...
SPEECH_ECHO_CANCEL ?= 1

SPEECH_NOISE_SUPPRESS ?= 0

LC_MMSE_NOISE_SUPPRESS ?= 1

LC_MMSE_NOISE_SUPPRESS_SPK ?= 0
...
SPEECH_PACKET_LOSS_CONCEALMENT ?= 1

SPEECH_WEIGHTING_FILTER_SUPPRESS ?= 1

SPEAKER_NOISE_SUPPRESS ?= 0

SPEAKER_WEIGHTING_FILTER_SUPPRESS ?= 1
...
#-D_SAMSUNG_AAC_DIFFRENT_BITRATE_\
#-D_IPHONE_6_SERIES_AAC_DIFFRENT_BITRATE_\
#-D_BRCM_CHIP_SERIES_AAC_DIFFRENT_BITRATE_\
