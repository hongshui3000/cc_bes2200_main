...
const struct HAL_IOMUX_PIN_FUNCTION_MAP cfg_hw_pinmux_pwl[CFG_HW_PLW_NUM] = {
	{HAL_GPIO_PIN_P2_6, HAL_IOMUX_FUNC_AS_GPIO, HAL_IOMUX_PIN_VOLTAGE_VIO, HAL_IOMUX_PIN_PULLUP_ENALBE},
	{HAL_GPIO_PIN_P0_3, HAL_IOMUX_FUNC_AS_GPIO, HAL_IOMUX_PIN_VOLTAGE_VIO, HAL_IOMUX_PIN_PULLUP_ENALBE},
};
...
const IIR_CFG_T audio_eq_hw_dac_iir_cfg = {
    ...
    .num = 3,
    .param = {
		{IIR_TYPE_PEAK, 2.0,   50.0,   0.5},
		{IIR_TYPE_PEAK, 2.0,   100.0,   2},
		{IIR_TYPE_PEAK, -3.0,  9000.0,   2},
    }
};
